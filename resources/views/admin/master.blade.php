...
{{--     <script src="public/admin/js/plugin/ckeditor/ckeditor.js"></script>
    ...
    <script src="public/admin/js/func_ckfinder.js"></script> --}}  
...
<body>
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="admin/cate/list">Trang Chủ Quản Trị</a>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        {{-- <li>
                            <a href="#"><i class="fa fa-cube fa-fw"></i> Product Image<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="admin/productImage/list">List Product Image</a>
                                </li>
                                <li>
                                    <a href="admin/productImage/add">Add Product Image</a>
                                </li>
                            </ul>
                            <!-- /.nav-second-level -->
                        </li> --}}
    ...
    {{-- my script --}}
    <script type="text/javascript" src="public/admin/templates/js/myscript.js"></script>
